    ...
    <div className="relative h-full overflow-hidden">
      ...
      >
        <div 
          ...
          {/* Hero Section */}
          <div className="relative h-[100vh] z-10 flex flex-col items-center justify-center text-center gap-[72px] h-full px-6">
              <h1
              ...
              {/* Two Cards */}
              <div
                className="w-full  flex flex-col md:flex-row items-center justify-center gap-[80px] mt-10"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <div
                    ...
                    className="relative bg-[#00000080] flex flex-col items-center justify-center w-[100%] max-w-[420px]  h-[258px] backdrop-blur-md rounded-[16px] p-6 text-white"
                >
                    <div className="absolute top-[-15%] bg-[#FFFFFF99] text-[black] text-[24px] py-[16px] px-[16px] rounded-[16px] font-semibold">I’m a Job Seeker</div>
                    ...
                    <button
                      ...
                      className="bg-[#014CCC] px-[32px] py-[16px] hover:bg-white hover:text-[#014CCC] text-white text-[28px] rounded-[16px] font-semibold transition">
                    Sign Up
                    </button>
                </div>
                ...
                <div
                    ...
                    className="relative bg-[#00000080] flex flex-col items-center justify-center w-[100%] max-w-[420px]  h-[258px] backdrop-blur-md rounded-[16px] p-6 text-white"
                >
                    <div className="absolute top-[-15%] bg-[#FFFFFF99] text-[black] text-[24px] py-[16px] px-[16px] rounded-[16px] font-semibold">I’m an Employer</div>
                    <p className="text-[24px] text-white mb-4">Hire top talent <br /> with ease.</p>
                    <button 
                      onClick={() =>
                        navigate("/signup/employer", { state: { background: location } })
                      }
                      className="bg-[#ffffff] px-[32px] py-[16px] hover:bg-blue-600 hover:text-white text-[#014CCC] text-[28px] rounded-[16px] font-semibold transition">
                    Sign Up
                    </button>
                </div>
              </div>
