...
const MyApplication = () => {
  return (
    <div className="text-black flex flex-col min-h-screen p-8 bg-[#D9D9D9] justify-between">

        <div className="w-full gap-6">
            <h1 className="text-2xl text-start font-bold mb-6">My Applications</h1>
            {applications.map((application, i) => (
            <JobCard key={i} job={application} />
            ))}
        </div>
